...
module_name = "trajectory_publisher_parameters"
yaml_file = f"{package_name}/trajectory_publisher_parameters.yaml"
...
setup(
    ...
    entry_points={
        "console_scripts": [
            f"trajectory_publisher = {package_name}.trajectory_publisher:main",
        ],
    },
)
